...
class KNNClassifier:
    ...
    def loadTrainingDataFromFile(self, file_path):
        if file_path is not None and os.path.exists(file_path):
            ...
            with open(file_path,'r') as training_data_file: #with statement itself ensures proper addition and release of resources
                ...
                for row in reader:
                    if row['moviename'] == '?':
                        ...
                        self.training_labels.append(row['movietype'])   #labels is same as output
